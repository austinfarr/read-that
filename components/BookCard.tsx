...
export default function BookCard({
  ...
  const cardContent = (
    <>
      ...
      <div className="relative">
        ...
        <div className="absolute -inset-0.5 bg-gradient-to-r from-teal-400 via-blue-500 to-purple-500 rounded-xl opacity-0 md:group-hover:opacity-100 transition-all duration-500 blur-sm" />

        <div
          className={`relative overflow-hidden rounded-xl transition-all duration-500 w-[120px] sm:w-[150px] md:w-[180px] bg-slate-900 border border-slate-700/50 md:group-hover:border-slate-600 shadow-xl md:group-hover:shadow-2xl ${
          ...
          <div className="relative w-full h-[180px] sm:h-[220px] md:h-[260px]">
            ...
            {normalizedBook.imageUrl && !hasError ? (
              <Image
                ...
                className={`object-cover transition-all duration-500 md:group-hover:scale-110 md:group-hover:blur-[2px] ${
  ...
  if (href) {
    return (
      <Link
        href={href}
        className={`group relative transition-all duration-500 md:hover:scale-105 block ${className}`}
        prefetch={true}
      >
        {cardContent}
      </Link>
  ...
  return (
    <div
      className={`group relative transition-all duration-500 md:hover:scale-105 ${
